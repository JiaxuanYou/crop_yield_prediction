...
county_region = ee.FeatureCollection('ft:1S4EB6319wWW2sWQDPhDvmSBIVrD3iEmCLYB7nMM') #ft:18Ayj5e7JxxtTPm1BdMnnzWbZMrxMB49eqGDTsaSp
...
for loc1, loc2, lat, lon in locations.values:
    ...
    while True:
        try:
            export_oneimage(img, 'crop_yield/Data_county', fname, region, scale, crs)
        except:
            print('retry')
            time.sleep(10)
            continue
